...
namespace GameParams {
	 ...
	 * each controls how much import is put upon
	 * a specific heuristic, a general guideline is 
	 * C1 > C3 > C2 with C1 being fairly large in comparison
	 * and C2 generally being very small
	 * for example: C1 = 12, C2 = 1, C3 = 3
	 * or C1 = 20, C2 = 2, C3 = 5, and so on
	 */
	...
	/**
	 * move buffer for AI
	 * prevents move reduplication within the last
	 * few moves. This should be relatively small
	 * perhaps ideally in the single digits. Much larger
	 * and the AI will tend to forfeit early
	 */
