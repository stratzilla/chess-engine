 ...
 * defines behavior of the AI controller player
 */
...
Move Computer::negamaxHandler(int alf, int bet) {
	 ...
	 * leading to null move, so consider this the AI forfeiting
	 */
	if (bestMoves.size() == 0) {
	 ...
	 * a collection of the best moves here. Choose one stochastically
	 */
